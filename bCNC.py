...
#        self.bind('<Control-Key-h>',    self.replace)
        ...
        # HDO
        self.bind('<<Scan>>',        self.control.runScan)
        self.bind("<F5>", self.unlock)            
        self.bind("<F6>", self.softReset)            
        self.bind("<F7>", self.control.runScan)            
        self.bind("<F8>", self.gstate.laserControlHotkey)            
